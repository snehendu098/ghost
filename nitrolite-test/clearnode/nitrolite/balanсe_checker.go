...
func (_BalanceChecker *BalanceCheckerTransactor) Fallback(opts *bind.TransactOpts, calldata []byte) (*types.Transaction, error) {
	return _BalanceChecker.contract.RawTransact(opts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() payable returns()
func (_BalanceChecker *BalanceCheckerSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _BalanceChecker.Contract.Fallback(&_BalanceChecker.TransactOpts, calldata)
}

// Fallback is a paid mutator transaction binding the contract fallback function.
//
// Solidity: fallback() payable returns()
func (_BalanceChecker *BalanceCheckerTransactorSession) Fallback(calldata []byte) (*types.Transaction, error) {
	return _BalanceChecker.Contract.Fallback(&_BalanceChecker.TransactOpts, calldata)
}