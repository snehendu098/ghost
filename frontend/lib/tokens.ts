...
export const tokens: Token[] = [
  { id: "btc", symbol: "BTC", name: "Bitcoin", color: "#f7931a", price: 70338, networks: ["ethereum", "bnb", "avalanche"] },
  { id: "eth", symbol: "ETH", name: "Ethereum", color: "#627eea", price: 2053, networks: ["ethereum", "optimism", "base", "polygon"] },
  ...
  { id: "usdt", symbol: "USDT", name: "Tether", color: "#26a17b", price: 1, networks: ["ethereum", "bnb", "avalanche", "polygon", "optimism", "solana"] },
  { id: "usdc", symbol: "USDC", name: "USD Coin", color: "#2775ca", price: 1, networks: ["ethereum", "bnb", "avalanche", "polygon", "optimism", "solana", "base"] },
  ...
  { id: "dai", symbol: "DAI", name: "Dai", color: "#f5ac37", price: 1, networks: ["ethereum", "polygon", "optimism"] },
  { id: "link", symbol: "LINK", name: "Chainlink", color: "#2a5ada", price: 8.86, networks: ["ethereum", "polygon", "optimism", "avalanche"] },
];
